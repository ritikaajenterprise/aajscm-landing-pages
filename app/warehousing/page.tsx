...
/**
 * Warehousing landing page, migrated from the Lovable build's
 * /lp-preview/warehousing route (standalone Hostinger LP shell).
 * GTM is only injected when NEXT_PUBLIC_LP_GTM_ID is set, matching
 * the source build's templated %LP_GTM_HEAD%/%LP_GTM_BODY% behavior.
 */
